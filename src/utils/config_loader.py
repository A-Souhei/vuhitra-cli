...
class ConfigLoader:
    ...
    def get_context_compacter_enabled(self):
        return self.get('context_compacter', 'enabled', default=True)

    def get_context_compacter_config(self):
        return self.get('context_compacter', default={})
