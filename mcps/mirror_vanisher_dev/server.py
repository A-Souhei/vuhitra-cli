...
class MCPServer:
    ...
    def _register_tools(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "get_todo_list": {
                "description": "Retrieve the current TODO_list from memory that was generated by the most recent create_plan call. Use this when you need to check the current plan steps, review TODO items, track progress on implementation steps, or reference the plan without creating a new one. Returns the TODO_list array with each step's number, action, details, and status.",
                "inputSchema": {
                    "type": "object",
                    "properties": {},
                    "required": []
